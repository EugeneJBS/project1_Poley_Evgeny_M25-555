...
ROOMS = {
    ...
    'garden': {
        'description': (
            'Заброшенный сад. Сквозь дыры в потолке падает свет, '
            'который освещает каменную статую.'
        ),
        'exits': {'east': 'entrance'},
        'items': ['silver_leaf'],
        'puzzle': None
    ...
    'cellar': {
        'description': (
            'Сырой винный погреб. Повсюду стоят пустые бочки и разбитые бутылки.'
        ),
        'exits': {'west': 'hall'},
        'items': ['old_bottle'],
        'puzzle': (
            'На старой бочке вырезано: "Сколько будет два в третьей степени?"',
            '8'
        )
    },
    'laboratory': {
        'description': (
            'Тайная лаборатория алхимика. Столы заставлены ретортами '
            'с остатками светящихся реагентов.'
        ),
        'exits': {'south': 'armory'},
        'items': ['blue_potion'],
        'puzzle': (
            'Запись на обрывке бумаги: "Что не имеет веса, но его может '
            'увидеть каждый?"',
            'тень'
        )
    }
